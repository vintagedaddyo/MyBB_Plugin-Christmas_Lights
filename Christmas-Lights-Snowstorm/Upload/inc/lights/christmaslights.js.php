...
//edited for MyBB plugin
function makeInact() {
  document.getElementById('lights').className = 'lightsInactive';
}

soundManager.url = '<?php echo $bburl;?>/inc/lights/';
...
//  var urlBase = (urlBase?urlBase:'lights/');
  var urlBase = '<?php echo $bburl;?>/inc/lights/';
  writeDebug('XLSF()');
